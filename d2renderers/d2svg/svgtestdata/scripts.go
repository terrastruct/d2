...
// Scripts contains D2 test scripts shared between dark_theme and dual_theme tests.
// These scripts are used to test different rendering modes with consistent inputs.
var Scripts = map[string]string{
	"basic": `a -> b
`,
	"child_to_child": `winter.snow -> summer.sun
		`,
	"animated": `winter.snow -> summer.sun -> trees -> winter.snow: { style.animated: true }
		`,
	"connection_label": `a -> b: hello
		`,
	"twitter": `timeline mixer: "" {
  explanation: |md
    ## **Timeline mixer**
