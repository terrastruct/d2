...
- `d2` now lives in the root folder of the repository instead of as a subcommand, so the root module can be installed directly from source. [#290](https://github.com/terrastruct/d2/pull/290)
